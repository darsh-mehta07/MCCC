...
export class Splash1Component implements OnInit {
  slides = [
    ...
    {"no": 3,class1:"event",class2:"event-content",class3:"slide-btn3",img: "../../assets/img/events.svg",title:"Events",des:"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry’s.",link:"/welcome"}
  ];
  constructor() { }
  //-----slick slider------------//    
