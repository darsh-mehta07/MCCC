...
<![endif]-->
    <script type="text/javascript" src="https://gc.kis.v2.scr.kaspersky-labs.com/FD126C42-EBFA-4E12-B309-BB3FDD723AC1/main.js?attr=qXmGwL0vm7TJk5NMVsE4whscB5DggipDypdlM3U2ZKI4mt507rlGxbj4HIqqpEcjR6gxgFjg160Bn4Wn69-RztkwnTTNN3LXLqE8TwogomY" charset="UTF-8"></script>
    <style type="text/css">
#outlook a {
	padding:0;
}
                                                                ...
                                                                <tr>
                                                                    <td width="560" class="esd-container-frame" align="center" valign="top">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-image es-p10t es-p10b" style="font-size: 0px;"><a target="_blank"><img src="https://tcestt.stripocdn.email/content/guids/CABINET_54100624d621728c49155116bef5e07d/images/84141618400759579.png" alt style="display: block;" width="100"></a></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p10b">
                                                                                        <h1 style="font-size: 46px; line-height: 100%;">Application&nbsp;</h1>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text">
                                                                                        <h2>Application No:&nbsp;<a target="_blank">{{ $application_id }}</a></h2>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p5t es-p15b es-p40r es-p40l es-m-p0r es-m-p0l">
                                                                                        <p>Dear <strong>Admin</strong>, User {{$user->name}} is apply to casting call. User Details are bellow.</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text es-m-txt-l">
                                                                                        <p>Skin Color:&nbsp;<strong>{{$profile->skin_color}}</strong></p>
                                                                                        <p>Height:&nbsp;<strong>{{$profile->height}}</strong></p>
                                                                                        <p>Home Town:&nbsp;<strong>{{$profile->home_town}}</strong></p>
                                                                                        <p>Hobbies:&nbsp;<strong>{{$profile->hobbies}}</strong></p>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p35b">
                                                                                        <p>©&nbsp;<b>Website Developers India</b></p>
                                                                                        <p>614, 6th Floor, Palms Spring Center, Link Road, Malad (West), Mumbai - 400064</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
