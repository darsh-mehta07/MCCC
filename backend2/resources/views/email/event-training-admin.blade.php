                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p10b">
                                                                                        <h1 style="font-size: 46px; line-height: 100%;">{{$subjectForAdmin}}&nbsp;</h1>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p5t es-p15b es-p40r es-p40l es-m-p0r es-m-p0l">
                                                                                        <p>Dear <strong>Admin</strong>, User {{$user->name}} has registered for {{$event[0]['title']}} event .</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text es-m-txt-l">
                                                                                        <p>Emergency Contact:&nbsp;<strong>{{$eventdata['emergancy_contact']}}</strong></p>
                                                                                        <p>institution_name:&nbsp;<strong>{{$eventdata['institution_name']}}</strong></p>
                                                                                        <p>About Event:&nbsp;<strong>{{$eventdata['about_event']}}</strong></p>
